<template>
  <div class="set-page-root absolute top-10vh flex justify-start">
...
<style lang="less">
// 用唯一根类限定作用域，避免 .bgDefend 全局样式泄漏到「设备维护 / 质检设置」等其它页面
.set-page-root {
  .bgDefend {
    .bg_listItem {
      padding: 2vh 0;
    ...
    .bgDefend_item {
      ...
      .bg_listItem {
        ...
        // 原 ::v-deep 写在全局块里不会被编译（死样式），改裸选择器；外层已用 .set-page-root 限定作用域
        .ant-form-item {
          margin-bottom: 0vh;
        }
        .ant-form-item-label {
