    ...
    <div class="bgT h-full flex items-center justify-center font-[siyuan] mt-2vh">
      ...
      <div class="z-2 flex justify-center mb-6.5vh">
        <div class="w-60vw rounded-lg py-2vh">
          ...
          <!-- 两种登录方式 -->
          <div class="mb-12vh flex justify-center gap-8vw">
            <!-- 指纹识别登录 -->
            <div class="relative flex flex-col cursor-pointer items-center transition-transform duration-300 hover:scale-105" @click="handleLogin('fingerprint')">
            ...
            <!-- 人脸识别登录 -->
            <div class="relative flex flex-col cursor-pointer items-center transition-transform duration-300 hover:scale-105" @click="handleLogin('face')">
          ...
          <!-- 底部按钮 -->
          <div class="flex justify-center gap-13vw">
