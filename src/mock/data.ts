...
const tssMock: Record<string, (params?: any) => any> = {
  ...
  '/tss/doc-machine/module-status': (params?: any) => {
    ...
    const moduleMock: Record<string, any[]> = {
      ...
      m4: [
        { uid: 'M3_BELT_JOB', code: 0, msg: '', mainCode: 0, subCode: 0, exDoc: [] },
        { uid: 'M3_STORE_OUT_JOB', code: 0, msg: '', mainCode: 0, subCode: 0, exDoc: [] },
        { uid: 'M3_WAIT1_JOB', code: 0, msg: '', mainCode: 0, subCode: 0, exDoc: [] },
        {
          uid: 'M3_DUMMY_JOB',
          code: 1,
          msg: '',
          ...
          subCode: 0,
          exDoc: [
            { fwBookSn: 1, fwDocSn: 2, docID: 'PE0000002' },
            { fwBookSn: 2, fwDocSn: 3, docID: 'PE0000003' },
            { fwBookSn: 3, fwDocSn: 4, docID: 'PE0000004' },
            { fwBookSn: 4, fwDocSn: 5, docID: 'PE0000005' },
          ],
        },
        { uid: 'M3_DELIVER_JOB', code: 0, msg: '', mainCode: 0, subCode: 0, exDoc: [] },
        { uid: 'M3_INKJET_JOB', code: 0, msg: '', mainCode: 0, subCode: 0, exDoc: [] },
        { uid: 'M3_WAIT2_JOB', code: 0, msg: '', mainCode: 0, subCode: 0, exDoc: [] },
        { uid: 'M3_STORE_IN_JOB', code: 0, msg: '', mainCode: 0, subCode: 0, exDoc: [] },
        { uid: 'M3_PUSH_JOB', code: 0, msg: '', mainCode: 0, subCode: 0, exDoc: [] },
        { uid: 'INKJET1_BOOK_STORE', code: 0, msg: '', mainCode: 0, subCode: 0, exDoc: [] },
      ],
      m6: [
        {
          uid: 'M6_SLEW_JOB',
